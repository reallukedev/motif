...
Motif is an app for iPhone and Mac that keeps a history of the music you play in Apple
...
- **Delete the app:** removes Motif's database and settings from that device. Your history remains in iCloud until you delete it there, and on your other devices. On iPhone the system can keep Keychain items after an app is deleted, so disconnect Last.fm in Motif first if you want its key removed straight away.
